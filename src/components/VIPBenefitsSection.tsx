...
export const VIPBenefitsSection = () => {
  return (
    <section id="beneficios" className="relative py-4 md:py-6 px-3 bg-black scroll-mt-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {/* Main container */}
            <div className="relative bg-black border-2 border-gold/60 rounded-3xl p-3 md:p-6 space-y-2 md:space-y-3">
